...
@inline x_f_cross_U(i, j, k, grid::AbstractHorizontallyCurvilinearGrid, coriolis::VIEnergy, U) =
    @inbounds - ℑyᵃᶜᵃ(i, j, k, grid, f_ℑx_vᶠᶠᵃ, coriolis, U[2]) / Δxᶠᶜᵃ(i, j, k, grid)

@inline y_f_cross_U(i, j, k, grid::AbstractHorizontallyCurvilinearGrid, coriolis::VIEnergy, U) =
